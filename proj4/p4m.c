...
//union has shared memory address
//struct doesn't
union semun 
{
        int val; 
        struct semid_ds *buf; // pointer to struct
        ushort *array; //pointer to array
};
...
int main(int argc, char *argv[])
{
	...
	//loop to save values into the semaphore array and make sure the values are positive integers
	...
	arg.buf = &sem_buf; //make the pointer in union semun point the address of sem_buf
	...
	//print out the time the semaphore set was created.
